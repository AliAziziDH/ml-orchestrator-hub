...
if __name__ == "__main__":
    ...
    print("=" * 80)
    print("From:          Conductor <ali@ali-antigravity.io> (Strictly authorized & DKIM-signed) [186]")
    print("To:            Orchestra Inbound Parser <spark-webhook@ali-antigravity-hub-2026.iam.gserviceaccount.com>")
    print(f"Subject:       Re: [SUSPENDED] Action Required: SLSQP Weight Optimization ({THREAD_ID})")
    print(f"In-Reply-To:   {msg_id}")
    print(f"References:    {msg_id}")
    print("-" * 80)
    print("Body Content (Plain Text):")
    print("-" * 80)
    print("APPROVE: Start the baseline SLSQP optimization run for EXP-HP-001 on house-prices-kaggle.")
